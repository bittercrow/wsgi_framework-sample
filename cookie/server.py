...
class MyWSGIHandler(object):
    ...
    def get_environ(self, byte_request):
        ...
        # リクエストラインの確認
        print('HTTP_REQUEST_TIME:{}'.format(datetime.now()))
        [print(line.decode('utf-8')) for line in byte_request_lines]
        ...
        # Cookieヘッダについて
        # クライアントからのリクエストラインのうち、"Cookie:"始まりのものをクッキーとみなす
    ...
    def start_response(self, status, response_headers, exc_info=None):
        server_headers = [
            # http://stackoverflow.com/a/225177
